...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoremembergiftcardconsumerecord/RetailStoreMemberGiftCardConsumeRecord$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoremembergiftcard/RetailStoreMemberGiftCard$Info.jsp" />

<c:set var="consumerOrder" value="${ result.bizOrder}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/consumerorder/ConsumerOrder$Info.jsp" />
