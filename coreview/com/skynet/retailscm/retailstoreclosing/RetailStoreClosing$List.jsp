...
<c:set var="retailStoreClosingList" value="${result.retailStoreClosingList}"/>
...
<c:if test="${ empty retailStoreClosingList}" >
 ...
 <c:if test="${not empty result.retailStoreClosingList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("retailStoreClosingList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/retailStoreClosingList;retailStoreClosingListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.retailStoreClosingList}">
				<tr currentVersion='${item.version}' id="retailStoreClosing-${item.id}" ><td><a class="link-action-removed" href="./retailStoreClosingManager/loadRetailStoreClosingDetail/${item.id}/"> ${item.id}</a></td>
