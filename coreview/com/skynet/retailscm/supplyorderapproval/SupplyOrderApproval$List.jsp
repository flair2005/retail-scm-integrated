...
<c:set var="supplyOrderApprovalList" value="${result.supplyOrderApprovalList}"/>
...
<c:if test="${ empty supplyOrderApprovalList}" >
 ...
 <c:if test="${not empty result.supplyOrderApprovalList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("supplyOrderApprovalList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/supplyOrderApprovalList;supplyOrderApprovalListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.supplyOrderApprovalList}">
				<tr currentVersion='${item.version}' id="supplyOrderApproval-${item.id}" ><td><a class="link-action-removed" href="./supplyOrderApprovalManager/loadSupplyOrderApprovalDetail/${item.id}/"> ${item.id}</a></td>
