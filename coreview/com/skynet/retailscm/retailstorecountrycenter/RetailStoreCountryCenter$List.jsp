...
<c:set var="retailStoreCountryCenterList" value="${result.retailStoreCountryCenterList}"/>
...
<c:if test="${ empty retailStoreCountryCenterList}" >
 ...
 <c:if test="${not empty result.retailStoreCountryCenterList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("retailStoreCountryCenterList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/retailStoreCountryCenterList;retailStoreCountryCenterListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.retailStoreCountryCenterList}">
				<tr currentVersion='${item.version}' id="retailStoreCountryCenter-${item.id}" ><td><a class="link-action-removed" href="./retailStoreCountryCenterManager/loadRetailStoreCountryCenterDetail/${item.id}/"> ${item.id}</a></td>
