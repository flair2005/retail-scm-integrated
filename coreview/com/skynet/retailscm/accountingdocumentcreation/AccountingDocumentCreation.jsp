...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentcreation/AccountingDocumentCreation$Summary.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="creation">
			<jsp:include page="/coreview/com/skynet/retailscm/accountingdocument/AccountingDocument$List.jsp" >
				<jsp:param name="referName" value="creation"/>
			</jsp:include>
		</div>
	</c:if>
