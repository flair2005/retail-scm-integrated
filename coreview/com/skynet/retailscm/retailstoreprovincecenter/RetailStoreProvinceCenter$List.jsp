...
<c:set var="retailStoreProvinceCenterList" value="${result.retailStoreProvinceCenterList}"/>
...
<c:if test="${ empty retailStoreProvinceCenterList}" >
 ...
 <c:if test="${not empty result.retailStoreProvinceCenterList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("retailStoreProvinceCenterList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/retailStoreProvinceCenterList;retailStoreProvinceCenterListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.retailStoreProvinceCenterList}">
				<tr currentVersion='${item.version}' id="retailStoreProvinceCenter-${item.id}" ><td><a class="link-action-removed" href="./retailStoreProvinceCenterManager/loadRetailStoreProvinceCenterDetail/${item.id}/"> ${item.id}</a></td>
...
</c:if><c:if test="${param.referName ne 'country'}">	<td ><a href='./retailStoreCountryCenterManager/loadRetailStoreCountryCenterDetail/${item.country.id}/'>${item.country.id}</a></td>
</c:if>
				<td>
