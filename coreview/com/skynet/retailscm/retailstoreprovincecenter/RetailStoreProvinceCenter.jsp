...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreprovincecenter/RetailStoreProvinceCenter$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="provinceCenterDepartmentList" class="tab-pane fade sublist" refer-name="province_center">
			<jsp:include page="/coreview/com/skynet/retailscm/provincecenterdepartment/ProvinceCenterDepartment$List.jsp" >
				<jsp:param name="referName" value="provinceCenter"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["provinceCenterEmployeeList"] or ignoreListAccessControl}'>
		<div id="provinceCenterEmployeeList" class="tab-pane fade sublist" refer-name="province_center">
			<jsp:include page="/coreview/com/skynet/retailscm/provincecenteremployee/ProvinceCenterEmployee$List.jsp" >
				<jsp:param name="referName" value="provinceCenter"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["retailStoreCityServiceCenterList"] or ignoreListAccessControl}'>
		<div id="retailStoreCityServiceCenterList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/retailscm/retailstorecityservicecenter/RetailStoreCityServiceCenter$List.jsp" >
