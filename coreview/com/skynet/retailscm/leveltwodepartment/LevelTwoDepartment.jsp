...
<jsp:include page="/coreview/com/skynet/retailscm/leveltwodepartment/LevelTwoDepartment$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/levelonedepartment/LevelOneDepartment$Info.jsp" />
		...
		<div id="levelThreeDepartmentList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/retailscm/levelthreedepartment/LevelThreeDepartment$List.jsp" >
