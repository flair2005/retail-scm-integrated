...
<c:set var="originalVoucherCreationList" value="${result.originalVoucherCreationList}"/>
...
<c:if test="${ empty originalVoucherCreationList}" >
 ...
 <c:if test="${not empty result.originalVoucherCreationList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("originalVoucherCreationList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/originalVoucherCreationList;originalVoucherCreationListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.originalVoucherCreationList}">
				<tr currentVersion='${item.version}' id="originalVoucherCreation-${item.id}" ><td><a class="link-action-removed" href="./originalVoucherCreationManager/loadOriginalVoucherCreationDetail/${item.id}/"> ${item.id}</a></td>
