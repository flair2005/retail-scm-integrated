...
<jsp:include page="/coreview/com/skynet/retailscm/leveltwocategory/LevelTwoCategory$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/levelonecategory/LevelOneCategory$Info.jsp" />
		...
		<div id="levelThreeCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<jsp:include page="/coreview/com/skynet/retailscm/levelthreecategory/LevelThreeCategory$List.jsp" >
				<jsp:param name="referName" value="parentCategory"/>
			</jsp:include>
		</div>
	</c:if>
