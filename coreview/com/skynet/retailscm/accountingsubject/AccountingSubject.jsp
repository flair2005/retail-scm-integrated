...
<jsp:include page="/coreview/com/skynet/retailscm/accountingsubject/AccountingSubject$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/accountset/AccountSet$Info.jsp" />
		...
		<div id="accountingDocumentLineList" class="tab-pane fade sublist" refer-name="accounting_subject">
			<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentline/AccountingDocumentLine$List.jsp" >
				<jsp:param name="referName" value="accountingSubject"/>
			</jsp:include>
		</div>
	</c:if>
