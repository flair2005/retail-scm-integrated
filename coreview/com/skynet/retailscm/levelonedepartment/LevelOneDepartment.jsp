...
<jsp:include page="/coreview/com/skynet/retailscm/levelonedepartment/LevelOneDepartment$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="levelTwoDepartmentList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/retailscm/leveltwodepartment/LevelTwoDepartment$List.jsp" >
