...
<jsp:include page="/coreview/com/skynet/retailscm/goodsshelf/GoodsShelf$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/storagespace/StorageSpace$Info.jsp" />

<c:set var="supplierSpace" value="${ result.supplierSpace}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/supplierspace/SupplierSpace$Info.jsp" />

<c:set var="damageSpace" value="${ result.damageSpace}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/damagespace/DamageSpace$Info.jsp" />
		...
		<div id="goodsShelfStockCountList" class="tab-pane fade sublist" refer-name="shelf">
			<jsp:include page="/coreview/com/skynet/retailscm/goodsshelfstockcount/GoodsShelfStockCount$List.jsp" >
				<jsp:param name="referName" value="shelf"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["goodsAllocationList"] or ignoreListAccessControl}'>
		<div id="goodsAllocationList" class="tab-pane fade sublist" refer-name="goods_shelf">
			<jsp:include page="/coreview/com/skynet/retailscm/goodsallocation/GoodsAllocation$List.jsp" >
				<jsp:param name="referName" value="goodsShelf"/>
			</jsp:include>
		</div>
	</c:if>
