...
<jsp:include page="/coreview/com/skynet/retailscm/termination/Termination$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/terminationreason/TerminationReason$Info.jsp" />

<c:set var="terminationType" value="${ result.type}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/terminationtype/TerminationType$Info.jsp" />
		...
		<div id="employeeList" class="tab-pane fade sublist" refer-name="termination">
			<jsp:include page="/coreview/com/skynet/retailscm/employee/Employee$List.jsp" >
				<jsp:param name="referName" value="termination"/>
			</jsp:include>
		</div>
	</c:if>
