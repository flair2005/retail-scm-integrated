...
<jsp:include page="/coreview/com/skynet/retailscm/consumerorder/ConsumerOrder$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoremember/RetailStoreMember$Info.jsp" />

<c:set var="retailStore" value="${ result.store}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstore/RetailStore$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/supplyorderconfirmation/SupplyOrderConfirmation$Action.jsp" />

<c:set var="supplyOrderApproval" value="${ result.approval}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/supplyorderapproval/SupplyOrderApproval$Action.jsp" />

<c:set var="supplyOrderProcessing" value="${ result.processing}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/supplyorderprocessing/SupplyOrderProcessing$Action.jsp" />

<c:set var="supplyOrderShipment" value="${ result.shipment}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/supplyordershipment/SupplyOrderShipment$Action.jsp" />

<c:set var="supplyOrderDelivery" value="${ result.delivery}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/supplyorderdelivery/SupplyOrderDelivery$Action.jsp" />
		...
		<div id="consumerOrderLineItemList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/consumerorderlineitem/ConsumerOrderLineItem$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["consumerOrderShippingGroupList"] or ignoreListAccessControl}'>
		<div id="consumerOrderShippingGroupList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/consumerordershippinggroup/ConsumerOrderShippingGroup$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["consumerOrderPaymentGroupList"] or ignoreListAccessControl}'>
		<div id="consumerOrderPaymentGroupList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/consumerorderpaymentgroup/ConsumerOrderPaymentGroup$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["consumerOrderPriceAdjustmentList"] or ignoreListAccessControl}'>
		<div id="consumerOrderPriceAdjustmentList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/consumerorderpriceadjustment/ConsumerOrderPriceAdjustment$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["retailStoreMemberGiftCardConsumeRecordList"] or ignoreListAccessControl}'>
		<div id="retailStoreMemberGiftCardConsumeRecordList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/retailstoremembergiftcardconsumerecord/RetailStoreMemberGiftCardConsumeRecord$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
