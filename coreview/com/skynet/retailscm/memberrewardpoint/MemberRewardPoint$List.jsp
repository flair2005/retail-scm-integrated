...
<c:set var="memberRewardPointList" value="${result.memberRewardPointList}"/>
...
<c:if test="${ empty memberRewardPointList}" >
 ...
 <c:if test="${not empty result.memberRewardPointList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("memberRewardPointList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/memberRewardPointList;memberRewardPointListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.memberRewardPointList}">
				<tr currentVersion='${item.version}' id="memberRewardPoint-${item.id}" ><td><a class="link-action-removed" href="./memberRewardPointManager/loadMemberRewardPointDetail/${item.id}/"> ${item.id}</a></td>
