...
<c:set var="originalVoucherConfirmationList" value="${result.originalVoucherConfirmationList}"/>
...
<c:if test="${ empty originalVoucherConfirmationList}" >
 ...
 <c:if test="${not empty result.originalVoucherConfirmationList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("originalVoucherConfirmationList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/originalVoucherConfirmationList;originalVoucherConfirmationListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.originalVoucherConfirmationList}">
				<tr currentVersion='${item.version}' id="originalVoucherConfirmation-${item.id}" ><td><a class="link-action-removed" href="./originalVoucherConfirmationManager/loadOriginalVoucherConfirmationDetail/${item.id}/"> ${item.id}</a></td>
