...
<jsp:include page="/coreview/com/skynet/retailscm/companytraining/CompanyTraining$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/instructor/Instructor$Info.jsp" />

<c:set var="trainingCourseType" value="${ result.trainingCourseType}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/trainingcoursetype/TrainingCourseType$Info.jsp" />
		...
		<div id="employeeCompanyTrainingList" class="tab-pane fade sublist" refer-name="training">
			<jsp:include page="/coreview/com/skynet/retailscm/employeecompanytraining/EmployeeCompanyTraining$List.jsp" >
				<jsp:param name="referName" value="training"/>
			</jsp:include>
		</div>
	</c:if>
