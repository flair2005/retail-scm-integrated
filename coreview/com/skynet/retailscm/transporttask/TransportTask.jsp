...
<jsp:include page="/coreview/com/skynet/retailscm/transporttask/TransportTask$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/truckdriver/TruckDriver$Info.jsp" />

<c:set var="transportTruck" value="${ result.truck}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/transporttruck/TransportTruck$Info.jsp" />

<c:set var="transportFleet" value="${ result.belongsTo}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/transportfleet/TransportFleet$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="transport_task">
			<jsp:include page="/coreview/com/skynet/retailscm/goods/Goods$List.jsp" >
				<jsp:param name="referName" value="transportTask"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["transportTaskTrackList"] or ignoreListAccessControl}'>
		<div id="transportTaskTrackList" class="tab-pane fade sublist" refer-name="movement">
			<jsp:include page="/coreview/com/skynet/retailscm/transporttasktrack/TransportTaskTrack$List.jsp" >
				<jsp:param name="referName" value="movement"/>
			</jsp:include>
		</div>
	</c:if>
