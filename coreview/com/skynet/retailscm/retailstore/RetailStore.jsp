...
<jsp:include page="/coreview/com/skynet/retailscm/retailstore/RetailStore$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecityservicecenter/RetailStoreCityServiceCenter$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecreation/RetailStoreCreation$Action.jsp" />

<c:set var="retailStoreInvestmentInvitation" value="${ result.investmentInvitation}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreinvestmentinvitation/RetailStoreInvestmentInvitation$Action.jsp" />

<c:set var="retailStoreFranchising" value="${ result.franchising}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstorefranchising/RetailStoreFranchising$Action.jsp" />

<c:set var="retailStoreDecoration" value="${ result.decoration}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoredecoration/RetailStoreDecoration$Action.jsp" />

<c:set var="retailStoreOpening" value="${ result.opening}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreopening/RetailStoreOpening$Action.jsp" />

<c:set var="retailStoreClosing" value="${ result.closing}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreclosing/RetailStoreClosing$Action.jsp" />
		...
		<div id="consumerOrderList" class="tab-pane fade sublist" refer-name="store">
			<jsp:include page="/coreview/com/skynet/retailscm/consumerorder/ConsumerOrder$List.jsp" >
				<jsp:param name="referName" value="store"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["retailStoreOrderList"] or ignoreListAccessControl}'>
	...
	<c:if test='${not empty userContext.accessTokens["goodsList"] or ignoreListAccessControl}'>
		<div id="goodsList" class="tab-pane fade sublist" refer-name="retail_store">
			<jsp:include page="/coreview/com/skynet/retailscm/goods/Goods$List.jsp" >
				<jsp:param name="referName" value="retailStore"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["transportTaskList"] or ignoreListAccessControl}'>
		<div id="transportTaskList" class="tab-pane fade sublist" refer-name="end">
			<jsp:include page="/coreview/com/skynet/retailscm/transporttask/TransportTask$List.jsp" >
				<jsp:param name="referName" value="end"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["accountSetList"] or ignoreListAccessControl}'>
