...
<jsp:include page="/coreview/com/skynet/retailscm/goodssupplier/GoodsSupplier$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="supplierProductList" class="tab-pane fade sublist" refer-name="supplier">
			<jsp:include page="/coreview/com/skynet/retailscm/supplierproduct/SupplierProduct$List.jsp" >
				<jsp:param name="referName" value="supplier"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["supplyOrderList"] or ignoreListAccessControl}'>
	...
	<c:if test='${not empty userContext.accessTokens["accountSetList"] or ignoreListAccessControl}'>
		<div id="accountSetList" class="tab-pane fade sublist" refer-name="goods_supplier">
			<jsp:include page="/coreview/com/skynet/retailscm/accountset/AccountSet$List.jsp" >
				<jsp:param name="referName" value="goodsSupplier"/>
			</jsp:include>
		</div>
	</c:if>
