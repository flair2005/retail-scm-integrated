...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentconfirmation/AccountingDocumentConfirmation$Summary.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="confirmation">
			<jsp:include page="/coreview/com/skynet/retailscm/accountingdocument/AccountingDocument$List.jsp" >
				<jsp:param name="referName" value="confirmation"/>
			</jsp:include>
		</div>
	</c:if>
