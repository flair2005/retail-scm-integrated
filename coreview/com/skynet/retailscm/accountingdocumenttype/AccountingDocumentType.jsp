...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumenttype/AccountingDocumentType$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/accountset/AccountSet$Info.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="document_type">
			<jsp:include page="/coreview/com/skynet/retailscm/accountingdocument/AccountingDocument$List.jsp" >
				<jsp:param name="referName" value="documentType"/>
			</jsp:include>
		</div>
	</c:if>
