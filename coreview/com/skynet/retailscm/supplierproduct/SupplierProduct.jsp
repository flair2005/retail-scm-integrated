...
<jsp:include page="/coreview/com/skynet/retailscm/supplierproduct/SupplierProduct$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/goodssupplier/GoodsSupplier$Info.jsp" />
		...
		<div id="productSupplyDurationList" class="tab-pane fade sublist" refer-name="product">
			<jsp:include page="/coreview/com/skynet/retailscm/productsupplyduration/ProductSupplyDuration$List.jsp" >
				<jsp:param name="referName" value="product"/>
			</jsp:include>
		</div>
	</c:if>
