...
<jsp:include page="/coreview/com/skynet/retailscm/goods/Goods$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/sku/Sku$Info.jsp" />

<c:set var="receivingSpace" value="${ result.receivingSpace}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/receivingspace/ReceivingSpace$Info.jsp" />

<c:set var="goodsAllocation" value="${ result.goodsAllocation}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/goodsallocation/GoodsAllocation$Info.jsp" />

<c:set var="smartPallet" value="${ result.smartPallet}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/smartpallet/SmartPallet$Info.jsp" />

<c:set var="shippingSpace" value="${ result.shippingSpace}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/shippingspace/ShippingSpace$Info.jsp" />

<c:set var="transportTask" value="${ result.transportTask}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/transporttask/TransportTask$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/supplyorder/SupplyOrder$Info.jsp" />

<c:set var="retailStoreOrder" value="${ result.retailStoreOrder}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorder/RetailStoreOrder$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/goodspackaging/GoodsPackaging$Action.jsp" />
		...
		<div id="goodsMovementList" class="tab-pane fade sublist" refer-name="goods">
			<jsp:include page="/coreview/com/skynet/retailscm/goodsmovement/GoodsMovement$List.jsp" >
				<jsp:param name="referName" value="goods"/>
			</jsp:include>
		</div>
	</c:if>
