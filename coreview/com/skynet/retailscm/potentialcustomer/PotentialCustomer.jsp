...
<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomer/PotentialCustomer$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/citypartner/CityPartner$Info.jsp" />
		...
		<div id="potentialCustomerContactPersonList" class="tab-pane fade sublist" refer-name="potential_customer">
			<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomercontactperson/PotentialCustomerContactPerson$List.jsp" >
				<jsp:param name="referName" value="potentialCustomer"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["potentialCustomerContactList"] or ignoreListAccessControl}'>
		<div id="potentialCustomerContactList" class="tab-pane fade sublist" refer-name="potential_customer">
			<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomercontact/PotentialCustomerContact$List.jsp" >
				<jsp:param name="referName" value="potentialCustomer"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["eventAttendanceList"] or ignoreListAccessControl}'>
		<div id="eventAttendanceList" class="tab-pane fade sublist" refer-name="potential_customer">
			<jsp:include page="/coreview/com/skynet/retailscm/eventattendance/EventAttendance$List.jsp" >
				<jsp:param name="referName" value="potentialCustomer"/>
			</jsp:include>
		</div>
	</c:if>
