...
<jsp:include page="/coreview/com/skynet/retailscm/levelonecategory/LevelOneCategory$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/catalog/Catalog$Info.jsp" />
		...
		<div id="levelTwoCategoryList" class="tab-pane fade sublist" refer-name="parent_category">
			<jsp:include page="/coreview/com/skynet/retailscm/leveltwocategory/LevelTwoCategory$List.jsp" >
