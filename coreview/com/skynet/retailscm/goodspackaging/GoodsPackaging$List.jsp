...
<c:set var="goodsPackagingList" value="${result.goodsPackagingList}"/>
...
<c:if test="${ empty goodsPackagingList}" >
 ...
 <c:if test="${not empty result.goodsPackagingList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("goodsPackagingList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/goodsPackagingList;goodsPackagingListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.goodsPackagingList}">
				<tr currentVersion='${item.version}' id="goodsPackaging-${item.id}" ><td><a class="link-action-removed" href="./goodsPackagingManager/loadGoodsPackagingDetail/${item.id}/"> ${item.id}</a></td>
