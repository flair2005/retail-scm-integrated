...
<jsp:include page="/coreview/com/skynet/retailscm/originalvoucher/OriginalVoucher$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocument/AccountingDocument$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/originalvouchercreation/OriginalVoucherCreation$Action.jsp" />

<c:set var="originalVoucherConfirmation" value="${ result.confirmation}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/originalvoucherconfirmation/OriginalVoucherConfirmation$Action.jsp" />

<c:set var="originalVoucherAuditing" value="${ result.auditing}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/originalvoucherauditing/OriginalVoucherAuditing$Action.jsp" />
