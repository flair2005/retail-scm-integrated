...
<jsp:include page="/coreview/com/skynet/retailscm/employeecompanytraining/EmployeeCompanyTraining$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/employee/Employee$Info.jsp" />

<c:set var="companyTraining" value="${ result.training}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/companytraining/CompanyTraining$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/scoring/Scoring$Action.jsp" />
