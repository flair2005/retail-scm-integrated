...
<div class="col-xs-12 col-md-4 section">
	...
	<li><span>ID</span><a class="link-action-removed" href="./originalVoucherAuditingManager/loadOriginalVoucherAuditingDetail/${originalVoucherAuditing.id}/"> ${originalVoucherAuditing.id}</a></li>
