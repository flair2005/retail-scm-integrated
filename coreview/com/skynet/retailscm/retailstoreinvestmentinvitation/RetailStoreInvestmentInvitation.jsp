...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreinvestmentinvitation/RetailStoreInvestmentInvitation$Summary.jsp" />
		...
		<div id="retailStoreList" class="tab-pane fade sublist" refer-name="investment_invitation">
			<jsp:include page="/coreview/com/skynet/retailscm/retailstore/RetailStore$List.jsp" >
				<jsp:param name="referName" value="investmentInvitation"/>
			</jsp:include>
		</div>
	</c:if>
