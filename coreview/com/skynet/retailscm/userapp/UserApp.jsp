...
<jsp:include page="/coreview/com/skynet/retailscm/userapp/UserApp$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/secuser/SecUser$Info.jsp" />
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<jsp:include page="/coreview/com/skynet/retailscm/objectaccess/ObjectAccess$List.jsp" >
