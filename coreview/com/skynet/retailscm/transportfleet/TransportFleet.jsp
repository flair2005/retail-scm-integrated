...
<jsp:include page="/coreview/com/skynet/retailscm/transportfleet/TransportFleet$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="transportTruckList" class="tab-pane fade sublist" refer-name="owner">
			<jsp:include page="/coreview/com/skynet/retailscm/transporttruck/TransportTruck$List.jsp" >
	...
	<c:if test='${not empty userContext.accessTokens["truckDriverList"] or ignoreListAccessControl}'>
		<div id="truckDriverList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/retailscm/truckdriver/TruckDriver$List.jsp" >
