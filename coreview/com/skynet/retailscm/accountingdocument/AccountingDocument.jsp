...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocument/AccountingDocument$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/accountingperiod/AccountingPeriod$Info.jsp" />

<c:set var="accountingDocumentType" value="${ result.documentType}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumenttype/AccountingDocumentType$Info.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentcreation/AccountingDocumentCreation$Action.jsp" />

<c:set var="accountingDocumentConfirmation" value="${ result.confirmation}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentconfirmation/AccountingDocumentConfirmation$Action.jsp" />

<c:set var="accountingDocumentAuditing" value="${ result.auditing}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentauditing/AccountingDocumentAuditing$Action.jsp" />

<c:set var="accountingDocumentPosting" value="${ result.posting}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentposting/AccountingDocumentPosting$Action.jsp" />
		...
		<div id="originalVoucherList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/retailscm/originalvoucher/OriginalVoucher$List.jsp" >
	...
	<c:if test='${not empty userContext.accessTokens["accountingDocumentLineList"] or ignoreListAccessControl}'>
		<div id="accountingDocumentLineList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentline/AccountingDocumentLine$List.jsp" >
				<jsp:param name="referName" value="belongsTo"/>
			</jsp:include>
		</div>
	</c:if>
