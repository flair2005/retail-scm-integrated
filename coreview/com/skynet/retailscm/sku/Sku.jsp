...
<jsp:include page="/coreview/com/skynet/retailscm/sku/Sku$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/product/Product$Info.jsp" />
		...
		<div id="goodsList" class="tab-pane fade sublist" refer-name="sku">
			<jsp:include page="/coreview/com/skynet/retailscm/goods/Goods$List.jsp" >
				<jsp:param name="referName" value="sku"/>
			</jsp:include>
		</div>
	</c:if>
