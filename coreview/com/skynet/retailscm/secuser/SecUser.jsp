...
<jsp:include page="/coreview/com/skynet/retailscm/secuser/SecUser$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/userdomain/UserDomain$Info.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<jsp:include page="/coreview/com/skynet/retailscm/userapp/UserApp$List.jsp" >
