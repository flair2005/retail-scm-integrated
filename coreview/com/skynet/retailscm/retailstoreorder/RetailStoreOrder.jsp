...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorder/RetailStoreOrder$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderconfirmation/RetailStoreOrderConfirmation$Action.jsp" />

<c:set var="retailStoreOrderApproval" value="${ result.approval}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderapproval/RetailStoreOrderApproval$Action.jsp" />

<c:set var="retailStoreOrderProcessing" value="${ result.processing}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderprocessing/RetailStoreOrderProcessing$Action.jsp" />

<c:set var="retailStoreOrderPicking" value="${ result.picking}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderpicking/RetailStoreOrderPicking$Action.jsp" />

<c:set var="retailStoreOrderShipment" value="${ result.shipment}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreordershipment/RetailStoreOrderShipment$Action.jsp" />

<c:set var="retailStoreOrderDelivery" value="${ result.delivery}" scope="request" />
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderdelivery/RetailStoreOrderDelivery$Action.jsp" />
		...
		<div id="retailStoreOrderLineItemList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderlineitem/RetailStoreOrderLineItem$List.jsp" >
	...
	<c:if test='${not empty userContext.accessTokens["retailStoreOrderShippingGroupList"] or ignoreListAccessControl}'>
		<div id="retailStoreOrderShippingGroupList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/retailstoreordershippinggroup/RetailStoreOrderShippingGroup$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["retailStoreOrderPaymentGroupList"] or ignoreListAccessControl}'>
		<div id="retailStoreOrderPaymentGroupList" class="tab-pane fade sublist" refer-name="biz_order">
			<jsp:include page="/coreview/com/skynet/retailscm/retailstoreorderpaymentgroup/RetailStoreOrderPaymentGroup$List.jsp" >
				<jsp:param name="referName" value="bizOrder"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["goodsList"] or ignoreListAccessControl}'>
		<div id="goodsList" class="tab-pane fade sublist" refer-name="retail_store_order">
			<jsp:include page="/coreview/com/skynet/retailscm/goods/Goods$List.jsp" >
				<jsp:param name="referName" value="retailStoreOrder"/>
			</jsp:include>
		</div>
	</c:if>
