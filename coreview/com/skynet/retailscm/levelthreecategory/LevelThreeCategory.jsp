...
<jsp:include page="/coreview/com/skynet/retailscm/levelthreecategory/LevelThreeCategory$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/leveltwocategory/LevelTwoCategory$Info.jsp" />
		...
		<div id="productList" class="tab-pane fade sublist" refer-name="parent_category">
			<jsp:include page="/coreview/com/skynet/retailscm/product/Product$List.jsp" >
