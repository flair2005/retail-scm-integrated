...
<c:set var="supplyOrderPickingList" value="${result.supplyOrderPickingList}"/>
...
<c:if test="${ empty supplyOrderPickingList}" >
 ...
 <c:if test="${not empty result.supplyOrderPickingList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("supplyOrderPickingList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/supplyOrderPickingList;supplyOrderPickingListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.supplyOrderPickingList}">
				<tr currentVersion='${item.version}' id="supplyOrderPicking-${item.id}" ><td><a class="link-action-removed" href="./supplyOrderPickingManager/loadSupplyOrderPickingDetail/${item.id}/"> ${item.id}</a></td>
