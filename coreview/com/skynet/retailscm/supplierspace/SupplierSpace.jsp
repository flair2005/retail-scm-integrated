...
<jsp:include page="/coreview/com/skynet/retailscm/supplierspace/SupplierSpace$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/warehouse/Warehouse$Info.jsp" />
		...
		<div id="goodsShelfList" class="tab-pane fade sublist" refer-name="supplier_space">
			<jsp:include page="/coreview/com/skynet/retailscm/goodsshelf/GoodsShelf$List.jsp" >
				<jsp:param name="referName" value="supplierSpace"/>
			</jsp:include>
		</div>
	</c:if>
