...
<jsp:include page="/coreview/com/skynet/retailscm/memberwishlist/MemberWishlist$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoremember/RetailStoreMember$Info.jsp" />
		...
		<div id="memberWishlistProductList" class="tab-pane fade sublist" refer-name="owner">
			<jsp:include page="/coreview/com/skynet/retailscm/memberwishlistproduct/MemberWishlistProduct$List.jsp" >
