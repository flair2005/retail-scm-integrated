...
<jsp:include page="/coreview/com/skynet/retailscm/goodsshelfstockcount/GoodsShelfStockCount$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/goodsshelf/GoodsShelf$Info.jsp" />
		...
		<div id="stockCountIssueTrackList" class="tab-pane fade sublist" refer-name="stock_count">
			<jsp:include page="/coreview/com/skynet/retailscm/stockcountissuetrack/StockCountIssueTrack$List.jsp" >
				<jsp:param name="referName" value="stockCount"/>
			</jsp:include>
		</div>
	</c:if>
