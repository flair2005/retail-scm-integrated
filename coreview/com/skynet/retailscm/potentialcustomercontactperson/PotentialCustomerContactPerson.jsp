...
<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomercontactperson/PotentialCustomerContactPerson$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomer/PotentialCustomer$Info.jsp" />
		...
		<div id="potentialCustomerContactList" class="tab-pane fade sublist" refer-name="contact_to">
			<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomercontact/PotentialCustomerContact$List.jsp" >
				<jsp:param name="referName" value="contactTo"/>
			</jsp:include>
		</div>
	</c:if>
