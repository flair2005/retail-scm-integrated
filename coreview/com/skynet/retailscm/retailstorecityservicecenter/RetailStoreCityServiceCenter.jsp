...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecityservicecenter/RetailStoreCityServiceCenter$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstoreprovincecenter/RetailStoreProvinceCenter$Info.jsp" />
		...
		<div id="cityPartnerList" class="tab-pane fade sublist" refer-name="city_service_center">
			<jsp:include page="/coreview/com/skynet/retailscm/citypartner/CityPartner$List.jsp" >
				<jsp:param name="referName" value="cityServiceCenter"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["potentialCustomerList"] or ignoreListAccessControl}'>
		<div id="potentialCustomerList" class="tab-pane fade sublist" refer-name="city_service_center">
			<jsp:include page="/coreview/com/skynet/retailscm/potentialcustomer/PotentialCustomer$List.jsp" >
				<jsp:param name="referName" value="cityServiceCenter"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["cityEventList"] or ignoreListAccessControl}'>
		<div id="cityEventList" class="tab-pane fade sublist" refer-name="city_service_center">
			<jsp:include page="/coreview/com/skynet/retailscm/cityevent/CityEvent$List.jsp" >
				<jsp:param name="referName" value="cityServiceCenter"/>
			</jsp:include>
		</div>
	</c:if>
