...
<c:set var="retailStoreCityServiceCenterList" value="${result.retailStoreCityServiceCenterList}"/>
...
<c:if test="${ empty retailStoreCityServiceCenterList}" >
 ...
 <c:if test="${not empty result.retailStoreCityServiceCenterList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("retailStoreCityServiceCenterList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/retailStoreCityServiceCenterList;retailStoreCityServiceCenterListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.retailStoreCityServiceCenterList}">
				<tr currentVersion='${item.version}' id="retailStoreCityServiceCenter-${item.id}" ><td><a class="link-action-removed" href="./retailStoreCityServiceCenterManager/loadRetailStoreCityServiceCenterDetail/${item.id}/"> ${item.id}</a></td>
...
</c:if><c:if test="${param.referName ne 'belongsTo'}">	<td ><a href='./retailStoreProvinceCenterManager/loadRetailStoreProvinceCenterDetail/${item.belongsTo.id}/'>${item.belongsTo.id}</a></td>
</c:if>
				<td>
