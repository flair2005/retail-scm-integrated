...
<jsp:include page="/coreview/com/skynet/retailscm/accountingdocumentauditing/AccountingDocumentAuditing$Summary.jsp" />
		...
		<div id="accountingDocumentList" class="tab-pane fade sublist" refer-name="auditing">
			<jsp:include page="/coreview/com/skynet/retailscm/accountingdocument/AccountingDocument$List.jsp" >
				<jsp:param name="referName" value="auditing"/>
			</jsp:include>
		</div>
	</c:if>
