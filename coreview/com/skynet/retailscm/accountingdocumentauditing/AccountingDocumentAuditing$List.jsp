...
<c:set var="accountingDocumentAuditingList" value="${result.accountingDocumentAuditingList}"/>
...
<c:if test="${ empty accountingDocumentAuditingList}" >
 ...
 <c:if test="${not empty result.accountingDocumentAuditingList}" >
    
    
<%

 	SmartList list=(SmartList)pageContext.getAttribute("accountingDocumentAuditingList"); 
...
<c:set var="currentPageNumber" value="${page.pageNumber}"/>
	...
	<li class="page-item ${classType}">
		<a href='#${ownerBeanName}Manager/load${ownerClassName}/${result.id}/accountingDocumentAuditingList;accountingDocumentAuditingListCurrentPage=${page.pageNumber}/' 
...
<th>${userContext.localeMap['@action']}</th>
		...
		<tbody>
			...
			<c:forEach var="item" items="${result.accountingDocumentAuditingList}">
				<tr currentVersion='${item.version}' id="accountingDocumentAuditing-${item.id}" ><td><a class="link-action-removed" href="./accountingDocumentAuditingManager/loadAccountingDocumentAuditingDetail/${item.id}/"> ${item.id}</a></td>
