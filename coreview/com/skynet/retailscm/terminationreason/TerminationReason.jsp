...
<jsp:include page="/coreview/com/skynet/retailscm/terminationreason/TerminationReason$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="terminationList" class="tab-pane fade sublist" refer-name="reason">
			<jsp:include page="/coreview/com/skynet/retailscm/termination/Termination$List.jsp" >
				<jsp:param name="referName" value="reason"/>
			</jsp:include>
		</div>
	</c:if>
