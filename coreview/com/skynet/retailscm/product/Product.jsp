...
<jsp:include page="/coreview/com/skynet/retailscm/product/Product$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/levelthreecategory/LevelThreeCategory$Info.jsp" />
		...
		<div id="skuList" class="tab-pane fade sublist" refer-name="product">
			<jsp:include page="/coreview/com/skynet/retailscm/sku/Sku$List.jsp" >
