...
<jsp:include page="/coreview/com/skynet/retailscm/userdomain/UserDomain$Summary.jsp" />
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<jsp:include page="/coreview/com/skynet/retailscm/secuser/SecUser$List.jsp" >
