...
<jsp:include page="/coreview/com/skynet/retailscm/catalog/Catalog$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/retailscm/retailstorecountrycenter/RetailStoreCountryCenter$Info.jsp" />
		...
		<div id="levelOneCategoryList" class="tab-pane fade sublist" refer-name="catalog">
			<jsp:include page="/coreview/com/skynet/retailscm/levelonecategory/LevelOneCategory$List.jsp" >
				<jsp:param name="referName" value="catalog"/>
			</jsp:include>
		</div>
	</c:if>
