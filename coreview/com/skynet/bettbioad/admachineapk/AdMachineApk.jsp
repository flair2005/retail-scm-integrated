...
<c:set var="ownerBeanName" value="adMachineApk" scope="request"/>
<c:set var="ownerClassName" value="AdMachineApk" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="adMachineApk" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/admachineapk/AdMachineApk$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./adMachineApkManager/transferToAnotherBelongsTo/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='adMachineApk' action=''>${userContext.localeMap['ad_machine_apk.transfer_to_belongs_to']}</a>
