...
<c:set var="ownerBeanName" value="maintenanceRecord" scope="request"/>
<c:set var="ownerClassName" value="MaintenanceRecord" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="maintenanceRecord" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/maintenancerecord/MaintenanceRecord$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./maintenanceRecordManager/transferToAnotherRefrigerator/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='maintenanceRecord' action=''>${userContext.localeMap['maintenance_record.transfer_to_refrigerator']}</a>
