...
<jsp:include page="/coreview/com/skynet/bettbioad/objectaccess/ObjectAccess$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/bettbioad/userapp/UserApp$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./objectAccessManager/transferToAnotherApp/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='objectAccess' action=''>${userContext.localeMap['object_access.transfer_to_app']}</a>
