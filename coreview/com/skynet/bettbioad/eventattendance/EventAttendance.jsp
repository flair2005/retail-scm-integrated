...
<jsp:include page="/coreview/com/skynet/bettbioad/eventattendance/EventAttendance$Summary.jsp" />
	...
	<div class="row">
<c:set var="contact" value="${ result.contact}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/contact/Contact$Info.jsp" />

<c:set var="adEvent" value="${ result.event}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/adevent/AdEvent$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./eventAttendanceManager/transferToAnotherContact/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='eventAttendance' action=''>${userContext.localeMap['event_attendance.transfer_to_contact']}</a>
<a href='./eventAttendanceManager/transferToAnotherEvent/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='eventAttendance' action=''>${userContext.localeMap['event_attendance.transfer_to_event']}</a>
