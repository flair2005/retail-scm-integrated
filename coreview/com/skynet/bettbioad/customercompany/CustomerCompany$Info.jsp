...
<div class="col-xs-12 col-md-4 section">
	<b title="A CustomerCompany">${userContext.localeMap['customer_company']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./customerCompanyManager/loadCustomerCompanyDetail/${customerCompany.id}/"> ${customerCompany.id}</a></li>
