...
<jsp:include page="/coreview/com/skynet/bettbioad/userapp/UserApp$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/bettbioad/secuser/SecUser$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./userAppManager/transferToAnotherSecUser/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='userApp' action=''>${userContext.localeMap['user_app.transfer_to_sec_user']}</a>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<jsp:include page="/coreview/com/skynet/bettbioad/objectaccess/ObjectAccess$List.jsp" >
				<jsp:param name="referName" value="app"/>
			</jsp:include>
		</div>
	</c:if>
