...
<div class="col-xs-12 col-md-4 section">
	<b title="A UserApp">${userContext.localeMap['user_app']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./userAppManager/loadUserAppDetail/${userApp.id}/"> ${userApp.id}</a></li>
