...
<div class="col-xs-12 col-md-3 action-section" >
	<b title="A ResearchGroup" style="color: green">${userContext.localeMap['research_group']}</b>
	<hr/>
	<ul>
	
	
	<li><span>${userContext.localeMap['research_group.id']}</span> ${researchGroup.id}</li>
