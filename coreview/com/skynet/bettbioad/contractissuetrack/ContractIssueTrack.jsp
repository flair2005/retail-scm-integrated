...
<c:set var="ownerBeanName" value="contractIssueTrack" scope="request"/>
<c:set var="ownerClassName" value="ContractIssueTrack" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="contractIssueTrack" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/contractissuetrack/ContractIssueTrack$Summary.jsp" />
	...
	<div class="row">
<c:set var="contract" value="${ result.contract}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/contract/Contract$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./contractIssueTrackManager/transferToAnotherContract/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='contractIssueTrack' action=''>${userContext.localeMap['contract_issue_track.transfer_to_contract']}</a>
