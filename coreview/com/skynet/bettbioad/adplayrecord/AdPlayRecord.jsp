...
<c:set var="ownerBeanName" value="adPlayRecord" scope="request"/>
<c:set var="ownerClassName" value="AdPlayRecord" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="adPlayRecord" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/adplayrecord/AdPlayRecord$Summary.jsp" />
...
<c:set var="marketingCampaign" value="${ result.adPage}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/marketingcampaign/MarketingCampaign$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./adPlayRecordManager/transferToAnotherRefrigerator/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='adPlayRecord' action=''>${userContext.localeMap['ad_play_record.transfer_to_refrigerator']}</a>
<a href='./adPlayRecordManager/transferToAnotherAdPage/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='adPlayRecord' action=''>${userContext.localeMap['ad_play_record.transfer_to_ad_page']}</a>
