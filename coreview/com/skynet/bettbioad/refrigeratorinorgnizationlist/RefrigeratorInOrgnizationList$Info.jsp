...
<div class="col-xs-12 col-md-4 section">
	<b title="A RefrigeratorInOrgnizationList">${userContext.localeMap['refrigerator_in_orgnization_list']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./refrigeratorInOrgnizationListManager/loadRefrigeratorInOrgnizationListDetail/${refrigeratorInOrgnizationList.id}/"> ${refrigeratorInOrgnizationList.id}</a></li>
