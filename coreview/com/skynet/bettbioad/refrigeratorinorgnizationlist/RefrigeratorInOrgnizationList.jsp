...
<c:set var="ownerBeanName" value="refrigeratorInOrgnizationList" scope="request"/>
<c:set var="ownerClassName" value="RefrigeratorInOrgnizationList" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="refrigeratorInOrgnizationList" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/refrigeratorinorgnizationlist/RefrigeratorInOrgnizationList$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./refrigeratorInOrgnizationListManager/transferToAnotherBelongsTo/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='refrigeratorInOrgnizationList' action=''>${userContext.localeMap['refrigerator_in_orgnization_list.transfer_to_belongs_to']}</a>
