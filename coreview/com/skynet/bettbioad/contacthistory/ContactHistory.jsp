...
<c:set var="ownerBeanName" value="contactHistory" scope="request"/>
<c:set var="ownerClassName" value="ContactHistory" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="contactHistory" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/contacthistory/ContactHistory$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./contactHistoryManager/transferToAnotherContact/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='contactHistory' action=''>${userContext.localeMap['contact_history.transfer_to_contact']}</a>
