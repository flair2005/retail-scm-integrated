...
<div class="col-xs-12 col-md-4 section">
	<b title="A ContactHistory">${userContext.localeMap['contact_history']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./contactHistoryManager/loadContactHistoryDetail/${contactHistory.id}/"> ${contactHistory.id}</a></li>
