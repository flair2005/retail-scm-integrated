...
<div class="col-xs-12 col-md-4 section">
	<b title="A SecUser">${userContext.localeMap['sec_user']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./secUserManager/loadSecUserDetail/${secUser.id}/"> ${secUser.id}</a></li>
