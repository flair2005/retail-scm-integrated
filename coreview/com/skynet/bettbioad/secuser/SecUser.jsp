...
<jsp:include page="/coreview/com/skynet/bettbioad/secuser/SecUser$Summary.jsp" />
...
<jsp:include page="/coreview/com/skynet/bettbioad/userdomain/UserDomain$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./secUserManager/transferToAnotherDomain/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='secUser' action=''>${userContext.localeMap['sec_user.transfer_to_domain']}</a>
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<jsp:include page="/coreview/com/skynet/bettbioad/userapp/UserApp$List.jsp" >
				<jsp:param name="referName" value="secUser"/>
			</jsp:include>
		</div>
	</c:if>
