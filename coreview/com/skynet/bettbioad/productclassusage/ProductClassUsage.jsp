...
<c:set var="ownerBeanName" value="productClassUsage" scope="request"/>
<c:set var="ownerClassName" value="ProductClassUsage" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="productClassUsage" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/productclassusage/ProductClassUsage$Summary.jsp" />
...
<c:set var="productClass" value="${ result.productClass}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/productclass/ProductClass$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./productClassUsageManager/transferToAnotherLaboratory/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='productClassUsage' action=''>${userContext.localeMap['product_class_usage.transfer_to_laboratory']}</a>
<a href='./productClassUsageManager/transferToAnotherProductClass/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='productClassUsage' action=''>${userContext.localeMap['product_class_usage.transfer_to_product_class']}</a>
