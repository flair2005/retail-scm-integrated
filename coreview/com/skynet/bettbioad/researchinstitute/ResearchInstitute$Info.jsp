...
<div class="col-xs-12 col-md-4 section">
	<b title="A ResearchInstitute">${userContext.localeMap['research_institute']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./researchInstituteManager/loadResearchInstituteDetail/${researchInstitute.id}/"> ${researchInstitute.id}</a></li>
