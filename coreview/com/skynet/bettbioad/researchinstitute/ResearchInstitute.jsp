...
<c:set var="ownerBeanName" value="researchInstitute" scope="request"/>
<c:set var="ownerClassName" value="ResearchInstitute" scope="request"/>
...
<div class="row">
	...
	<c:if test='${(not empty userContext.accessTokens["researchGroupList"]) or ignoreListAccessControl}'>
			<li><a data-toggle="tab" href="#researchGroupList" class="disabled"> ${userContext.localeMap['research_group']}</a></li>
	</c:if>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="researchInstitute" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/researchinstitute/ResearchInstitute$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./researchInstituteManager/transferToAnotherBelongsTo/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='researchInstitute' action=''>${userContext.localeMap['research_institute.transfer_to_belongs_to']}</a>
		...
		<c:if test='${not empty userContext.accessTokens["researchGroupList"] or ignoreListAccessControl}'>
		<div id="researchGroupList" class="tab-pane fade sublist" refer-name="belongs_to">
			<jsp:include page="/coreview/com/skynet/bettbioad/researchgroup/ResearchGroup$List.jsp" >
