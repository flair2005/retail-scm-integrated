...
<c:set var="ownerBeanName" value="adEvent" scope="request"/>
<c:set var="ownerClassName" value="AdEvent" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="adEvent" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/adevent/AdEvent$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./adEventManager/transferToAnotherBelongsTo/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='adEvent' action=''>${userContext.localeMap['ad_event.transfer_to_belongs_to']}</a>
		...
		<c:if test='${not empty userContext.accessTokens["eventAttendanceList"] or ignoreListAccessControl}'>
		<div id="eventAttendanceList" class="tab-pane fade sublist" refer-name="event">
