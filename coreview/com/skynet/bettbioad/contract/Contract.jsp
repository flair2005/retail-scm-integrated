...
<c:set var="ownerBeanName" value="contract" scope="request"/>
<c:set var="ownerClassName" value="Contract" scope="request"/>
...
<div class="row">
	...
	<c:if test='${(not empty userContext.accessTokens["contractIssueTrackList"]) or ignoreListAccessControl}'>
			<li><a data-toggle="tab" href="#contractIssueTrackList" class="disabled"> ${userContext.localeMap['contract_issue_track']}</a></li>
	</c:if>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="contract" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/contract/Contract$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./contractManager/transferToAnotherCompany/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='contract' action=''>${userContext.localeMap['contract.transfer_to_company']}</a>
		...
		<c:if test='${not empty userContext.accessTokens["contractIssueTrackList"] or ignoreListAccessControl}'>
		<div id="contractIssueTrackList" class="tab-pane fade sublist" refer-name="contract">
			<jsp:include page="/coreview/com/skynet/bettbioad/contractissuetrack/ContractIssueTrack$List.jsp" >
				<jsp:param name="referName" value="contract"/>
			</jsp:include>
		</div>
	</c:if>
