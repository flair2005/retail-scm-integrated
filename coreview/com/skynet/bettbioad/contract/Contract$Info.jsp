...
<div class="col-xs-12 col-md-4 section">
	<b title="A Contract">${userContext.localeMap['contract']}</b>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./contractManager/loadContractDetail/${contract.id}/"> ${contract.id}</a></li>
