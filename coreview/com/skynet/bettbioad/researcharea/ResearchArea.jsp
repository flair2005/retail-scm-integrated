...
<c:set var="ownerBeanName" value="researchArea" scope="request"/>
<c:set var="ownerClassName" value="ResearchArea" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="researchArea" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/researcharea/ResearchArea$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./researchAreaManager/transferToAnotherBelongsTo/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='researchArea' action=''>${userContext.localeMap['research_area.transfer_to_belongs_to']}</a>
		...
		<c:if test='${not empty userContext.accessTokens["laboratoryResearchAreaList"] or ignoreListAccessControl}'>
		<div id="laboratoryResearchAreaList" class="tab-pane fade sublist" refer-name="research_area">
			<jsp:include page="/coreview/com/skynet/bettbioad/laboratoryresearcharea/LaboratoryResearchArea$List.jsp" >
				<jsp:param name="referName" value="researchArea"/>
			</jsp:include>
		</div>
	</c:if>
