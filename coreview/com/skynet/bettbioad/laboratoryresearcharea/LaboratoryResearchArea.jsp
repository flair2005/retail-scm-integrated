...
<c:set var="ownerBeanName" value="laboratoryResearchArea" scope="request"/>
<c:set var="ownerClassName" value="LaboratoryResearchArea" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="laboratoryResearchArea" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/laboratoryresearcharea/LaboratoryResearchArea$Summary.jsp" />
	...
	<div class="row">
<c:set var="researchArea" value="${ result.researchArea}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/researcharea/ResearchArea$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./laboratoryResearchAreaManager/transferToAnotherResearchArea/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='laboratoryResearchArea' action=''>${userContext.localeMap['laboratory_research_area.transfer_to_research_area']}</a>
<a href='./laboratoryResearchAreaManager/transferToAnotherLaboratory/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='laboratoryResearchArea' action=''>${userContext.localeMap['laboratory_research_area.transfer_to_laboratory']}</a>
