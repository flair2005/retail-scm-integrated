...
<c:set var="ownerBeanName" value="adInPageList" scope="request"/>
<c:set var="ownerClassName" value="AdInPageList" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="adInPageList" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/adinpagelist/AdInPageList$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./adInPageListManager/transferToAnotherPlayList/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='adInPageList' action=''>${userContext.localeMap['ad_in_page_list.transfer_to_play_list']}</a>
<a href='./adInPageListManager/transferToAnotherAdPage/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='adInPageList' action=''>${userContext.localeMap['ad_in_page_list.transfer_to_ad_page']}</a>
