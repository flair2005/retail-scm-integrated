...
<c:set var="ownerBeanName" value="refrigeratorPlayList" scope="request"/>
<c:set var="ownerClassName" value="RefrigeratorPlayList" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="refrigeratorPlayList" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/refrigeratorplaylist/RefrigeratorPlayList$Summary.jsp" />
	...
	<div class="row">
<c:set var="refrigerator" value="${ result.refrigerator}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/refrigerator/Refrigerator$Info.jsp" />

<c:set var="playList" value="${ result.playList}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/playlist/PlayList$Info.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./refrigeratorPlayListManager/transferToAnotherRefrigerator/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='refrigeratorPlayList' action=''>${userContext.localeMap['refrigerator_play_list.transfer_to_refrigerator']}</a>
<a href='./refrigeratorPlayListManager/transferToAnotherPlayList/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='refrigeratorPlayList' action=''>${userContext.localeMap['refrigerator_play_list.transfer_to_play_list']}</a>
