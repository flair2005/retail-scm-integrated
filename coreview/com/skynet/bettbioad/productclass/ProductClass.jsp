...
<c:set var="ownerBeanName" value="productClass" scope="request"/>
<c:set var="ownerClassName" value="ProductClass" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="productClass" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/skynet/bettbioad/productclass/ProductClass$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<a href='./productClassManager/transferToAnotherBelongsTo/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='productClass' action=''>${userContext.localeMap['product_class.transfer_to_belongs_to']}</a>
		...
		<c:if test='${not empty userContext.accessTokens["productClassUsageList"] or ignoreListAccessControl}'>
		<div id="productClassUsageList" class="tab-pane fade sublist" refer-name="product_class">
			<jsp:include page="/coreview/com/skynet/bettbioad/productclassusage/ProductClassUsage$List.jsp" >
				<jsp:param name="referName" value="productClass"/>
			</jsp:include>
		</div>
	</c:if>
