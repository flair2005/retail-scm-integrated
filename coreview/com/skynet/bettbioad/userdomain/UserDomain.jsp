...
<jsp:include page="/coreview/com/skynet/bettbioad/userdomain/UserDomain$Summary.jsp" />
...
<div class="row" desc="action list">
	...
	<div class="col-xs-12 col-md-12 btn-toolbar">
		...
		<div id="secUserList" class="tab-pane fade sublist" refer-name="domain">
			<jsp:include page="/coreview/com/skynet/bettbioad/secuser/SecUser$List.jsp" >
				<jsp:param name="referName" value="domain"/>
			</jsp:include>
		</div>
	</c:if>
