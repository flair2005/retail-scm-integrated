...
<c:set var="ownerBeanName" value="taskFavorite" scope="request"/>
<c:set var="ownerClassName" value="TaskFavorite" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskFavorite" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskfavorite/TaskFavorite$Summary.jsp" />
