...
<c:set var="ownerBeanName" value="taskReply" scope="request"/>
<c:set var="ownerClassName" value="TaskReply" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskReply" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskreply/TaskReply$Summary.jsp" />
	...
	<div class="row">
<c:set var="communityUser" value="${ result.replier}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/communityuser/CommunityUser$Info.jsp" />

<c:set var="task" value="${ result.task}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/task/Task$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["taskReplyLikeList"] or ignoreListAccessControl}'>
		<div id="taskReplyLikeList" class="tab-pane fade sublist" refer-name="task_reply">
			<jsp:include page="/coreview/com/terapico/bbt/taskreplylike/TaskReplyLike$List.jsp" >
				<jsp:param name="referName" value="taskReply"/>
			</jsp:include>
		</div>
	</c:if>
