...
<c:set var="ownerBeanName" value="userMessage" scope="request"/>
<c:set var="ownerClassName" value="UserMessage" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userMessage" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/usermessage/UserMessage$Summary.jsp" />
	...
	<div class="row">
<c:set var="communityUser" value="${ result.receiver}" scope="request" />
