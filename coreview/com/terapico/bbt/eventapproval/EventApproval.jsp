...
<c:set var="ownerBeanName" value="eventApproval" scope="request"/>
<c:set var="ownerClassName" value="EventApproval" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventApproval" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventapproval/EventApproval$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["eventList"] or ignoreListAccessControl}'>
		<div id="eventList" class="tab-pane fade sublist" refer-name="approval">
			<jsp:include page="/coreview/com/terapico/bbt/event/Event$List.jsp" >
				<jsp:param name="referName" value="approval"/>
			</jsp:include>
		</div>
	</c:if>
