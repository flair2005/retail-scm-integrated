...
<c:set var="ownerBeanName" value="userSkill" scope="request"/>
<c:set var="ownerClassName" value="UserSkill" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="userSkill" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/userskill/UserSkill$Summary.jsp" />
