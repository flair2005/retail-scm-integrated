...
<div class="col-xs-12 col-md-4 section">
	<b title="A ThreadReply">${userContext.localeMap['thread_reply']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./threadReplyManager/loadThreadReplyDetail/${threadReply.id}/"> ${threadReply.id}</a></li>
