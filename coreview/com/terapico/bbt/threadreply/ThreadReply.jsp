...
<c:set var="ownerBeanName" value="threadReply" scope="request"/>
<c:set var="ownerClassName" value="ThreadReply" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadReply" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadreply/ThreadReply$Summary.jsp" />
