...
<jsp:include page="/coreview/com/terapico/bbt/secuser/SecUser$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/userdomain/UserDomain$Info.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<jsp:include page="/coreview/com/terapico/bbt/userapp/UserApp$List.jsp" >
	...
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<jsp:include page="/coreview/com/terapico/bbt/loginhistory/LoginHistory$List.jsp" >
				<jsp:param name="referName" value="secUser"/>
			</jsp:include>
		</div>
	</c:if>
