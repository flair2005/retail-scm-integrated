...
<c:set var="ownerBeanName" value="topicFilter" scope="request"/>
<c:set var="ownerClassName" value="TopicFilter" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="topicFilter" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topicfilter/TopicFilter$Summary.jsp" />
	...
	<div class="row">
<c:set var="topicPage" value="${ result.topicPage}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topicpage/TopicPage$Info.jsp" />
