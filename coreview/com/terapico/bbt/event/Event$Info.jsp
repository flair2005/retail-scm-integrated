...
<div class="col-xs-12 col-md-4 section">
	<b title="A Event">${userContext.localeMap['event']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./eventManager/loadEventDetail/${event.id}/"> ${event.id}</a></li>
