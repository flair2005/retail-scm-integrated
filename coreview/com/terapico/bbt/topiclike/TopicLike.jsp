...
<c:set var="ownerBeanName" value="topicLike" scope="request"/>
<c:set var="ownerClassName" value="TopicLike" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="topicLike" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topiclike/TopicLike$Summary.jsp" />
