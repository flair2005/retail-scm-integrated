...
<c:set var="ownerBeanName" value="eventRegistration" scope="request"/>
<c:set var="ownerClassName" value="EventRegistration" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventRegistration" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventregistration/EventRegistration$Summary.jsp" />
