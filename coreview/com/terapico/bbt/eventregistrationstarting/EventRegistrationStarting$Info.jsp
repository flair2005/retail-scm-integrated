...
<div class="col-xs-12 col-md-4 section">
	<b title="A EventRegistrationStarting">${userContext.localeMap['event_registration_starting']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./eventRegistrationStartingManager/loadEventRegistrationStartingDetail/${eventRegistrationStarting.id}/"> ${eventRegistrationStarting.id}</a></li>
