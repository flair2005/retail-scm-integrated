...
<c:set var="ownerBeanName" value="eventRegistrationStarting" scope="request"/>
<c:set var="ownerClassName" value="EventRegistrationStarting" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventRegistrationStarting" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventregistrationstarting/EventRegistrationStarting$Summary.jsp" />
