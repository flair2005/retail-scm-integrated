...
<c:set var="ownerBeanName" value="threadFavorite" scope="request"/>
<c:set var="ownerClassName" value="ThreadFavorite" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadFavorite" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadfavorite/ThreadFavorite$Summary.jsp" />
