...
<c:set var="ownerBeanName" value="topicFavorite" scope="request"/>
<c:set var="ownerClassName" value="TopicFavorite" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="topicFavorite" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topicfavorite/TopicFavorite$Summary.jsp" />
	...
	<div class="row">
<c:set var="communityUser" value="${ result.favoriteUser}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/communityuser/CommunityUser$Info.jsp" />

<c:set var="topic" value="${ result.topic}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topic/Topic$Info.jsp" />
