...
<c:set var="ownerBeanName" value="taskPage" scope="request"/>
<c:set var="ownerClassName" value="TaskPage" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskPage" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskpage/TaskPage$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/community/Community$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["taskFilterList"] or ignoreListAccessControl}'>
		<div id="taskFilterList" class="tab-pane fade sublist" refer-name="task_page">
			<jsp:include page="/coreview/com/terapico/bbt/taskfilter/TaskFilter$List.jsp" >
				<jsp:param name="referName" value="taskPage"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["taskList"] or ignoreListAccessControl}'>
		<div id="taskList" class="tab-pane fade sublist" refer-name="task_page">
