...
<c:set var="ownerBeanName" value="groupFilter" scope="request"/>
<c:set var="ownerClassName" value="GroupFilter" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="groupFilter" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/groupfilter/GroupFilter$Summary.jsp" />
