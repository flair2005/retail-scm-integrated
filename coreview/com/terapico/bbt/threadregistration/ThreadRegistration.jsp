...
<c:set var="ownerBeanName" value="threadRegistration" scope="request"/>
<c:set var="ownerClassName" value="ThreadRegistration" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadRegistration" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadregistration/ThreadRegistration$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/thread/Thread$Info.jsp" />
