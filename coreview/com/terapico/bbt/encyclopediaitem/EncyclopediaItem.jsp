...
<c:set var="ownerBeanName" value="encyclopediaItem" scope="request"/>
<c:set var="ownerClassName" value="EncyclopediaItem" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="encyclopediaItem" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/encyclopediaitem/EncyclopediaItem$Summary.jsp" />
