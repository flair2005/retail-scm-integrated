...
<c:set var="ownerBeanName" value="taskReplyLike" scope="request"/>
<c:set var="ownerClassName" value="TaskReplyLike" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskReplyLike" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskreplylike/TaskReplyLike$Summary.jsp" />
...
<c:set var="taskReply" value="${ result.taskReply}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskreply/TaskReply$Info.jsp" />
