...
<c:set var="ownerBeanName" value="taskWatch" scope="request"/>
<c:set var="ownerClassName" value="TaskWatch" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskWatch" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskwatch/TaskWatch$Summary.jsp" />
