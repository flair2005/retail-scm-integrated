...
<c:set var="ownerBeanName" value="patientInfo" scope="request"/>
<c:set var="ownerClassName" value="PatientInfo" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="patientInfo" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/patientinfo/PatientInfo$Summary.jsp" />
