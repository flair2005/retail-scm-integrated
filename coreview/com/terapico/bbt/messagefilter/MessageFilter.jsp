...
<c:set var="ownerBeanName" value="messageFilter" scope="request"/>
<c:set var="ownerClassName" value="MessageFilter" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="messageFilter" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/messagefilter/MessageFilter$Summary.jsp" />
	...
	<div class="row">
<c:set var="communityUser" value="${ result.user}" scope="request" />
