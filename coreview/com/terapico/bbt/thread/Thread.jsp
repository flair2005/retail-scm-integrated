...
<c:set var="ownerBeanName" value="thread" scope="request"/>
<c:set var="ownerClassName" value="Thread" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="thread" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/thread/Thread$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/grouppage/GroupPage$Info.jsp" />
	...
	<hr/><div class="row">
<c:set var="threadApproval" value="${ result.approval}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadapproval/ThreadApproval$Action.jsp" />

<c:set var="threadPublishing" value="${ result.publishing}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadpublishing/ThreadPublishing$Action.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["threadReplyList"] or ignoreListAccessControl}'>
		<div id="threadReplyList" class="tab-pane fade sublist" refer-name="thread">
			<jsp:include page="/coreview/com/terapico/bbt/threadreply/ThreadReply$List.jsp" >
				<jsp:param name="referName" value="thread"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["threadRegistrationList"] or ignoreListAccessControl}'>
		<div id="threadRegistrationList" class="tab-pane fade sublist" refer-name="thread">
	...
	<c:if test='${not empty userContext.accessTokens["threadLikeList"] or ignoreListAccessControl}'>
		<div id="threadLikeList" class="tab-pane fade sublist" refer-name="thread">
	...
	<c:if test='${not empty userContext.accessTokens["threadFavoriteList"] or ignoreListAccessControl}'>
		<div id="threadFavoriteList" class="tab-pane fade sublist" refer-name="thread">
