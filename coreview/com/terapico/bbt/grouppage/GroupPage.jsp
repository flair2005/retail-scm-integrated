...
<c:set var="ownerBeanName" value="groupPage" scope="request"/>
<c:set var="ownerClassName" value="GroupPage" scope="request"/>
...
<div class="row">
	...
	<c:if test='${(not empty userContext.accessTokens["groupFilterList"]) or ignoreListAccessControl}'>
			<li><a data-toggle="tab" href="#groupFilterList" class="disabled"> ${userContext.localeMap['group_filter']}</a></li>
	</c:if>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="groupPage" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/grouppage/GroupPage$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/community/Community$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["groupFilterList"] or ignoreListAccessControl}'>
		<div id="groupFilterList" class="tab-pane fade sublist" refer-name="group_page">
			<jsp:include page="/coreview/com/terapico/bbt/groupfilter/GroupFilter$List.jsp" >
				<jsp:param name="referName" value="groupPage"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["threadList"] or ignoreListAccessControl}'>
		<div id="threadList" class="tab-pane fade sublist" refer-name="group_page">
