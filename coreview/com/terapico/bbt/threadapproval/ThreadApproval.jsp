...
<c:set var="ownerBeanName" value="threadApproval" scope="request"/>
<c:set var="ownerClassName" value="ThreadApproval" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadApproval" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadapproval/ThreadApproval$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["threadList"] or ignoreListAccessControl}'>
		<div id="threadList" class="tab-pane fade sublist" refer-name="approval">
