...
<c:set var="ownerBeanName" value="threadLike" scope="request"/>
<c:set var="ownerClassName" value="ThreadLike" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadLike" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadlike/ThreadLike$Summary.jsp" />
