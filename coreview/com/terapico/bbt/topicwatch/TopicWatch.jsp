...
<c:set var="ownerBeanName" value="topicWatch" scope="request"/>
<c:set var="ownerClassName" value="TopicWatch" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="topicWatch" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topicwatch/TopicWatch$Summary.jsp" />
