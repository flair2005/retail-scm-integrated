...
<c:set var="ownerBeanName" value="taskFilter" scope="request"/>
<c:set var="ownerClassName" value="TaskFilter" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskFilter" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskfilter/TaskFilter$Summary.jsp" />
