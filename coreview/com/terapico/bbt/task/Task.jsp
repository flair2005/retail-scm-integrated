...
<c:set var="ownerBeanName" value="task" scope="request"/>
<c:set var="ownerClassName" value="Task" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="task" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/task/Task$Summary.jsp" />
...
<c:set var="taskPage" value="${ result.taskPage}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/taskpage/TaskPage$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["taskLikeList"] or ignoreListAccessControl}'>
		<div id="taskLikeList" class="tab-pane fade sublist" refer-name="task">
	...
	<c:if test='${not empty userContext.accessTokens["taskFavoriteList"] or ignoreListAccessControl}'>
		<div id="taskFavoriteList" class="tab-pane fade sublist" refer-name="task">
	...
	<c:if test='${not empty userContext.accessTokens["taskReplyList"] or ignoreListAccessControl}'>
		<div id="taskReplyList" class="tab-pane fade sublist" refer-name="task">
