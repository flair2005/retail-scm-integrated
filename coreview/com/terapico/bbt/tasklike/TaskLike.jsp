...
<c:set var="ownerBeanName" value="taskLike" scope="request"/>
<c:set var="ownerClassName" value="TaskLike" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="taskLike" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/tasklike/TaskLike$Summary.jsp" />
