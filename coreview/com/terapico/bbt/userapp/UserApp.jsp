...
<jsp:include page="/coreview/com/terapico/bbt/userapp/UserApp$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/secuser/SecUser$Info.jsp" />
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<jsp:include page="/coreview/com/terapico/bbt/objectaccess/ObjectAccess$List.jsp" >
