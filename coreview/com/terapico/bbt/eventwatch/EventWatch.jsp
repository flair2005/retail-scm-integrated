...
<c:set var="ownerBeanName" value="eventWatch" scope="request"/>
<c:set var="ownerClassName" value="EventWatch" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventWatch" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventwatch/EventWatch$Summary.jsp" />
	...
	<div class="row">
<c:set var="communityUser" value="${ result.watcher}" scope="request" />
