...
<c:set var="ownerBeanName" value="eventRegistrationStoping" scope="request"/>
<c:set var="ownerClassName" value="EventRegistrationStoping" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventRegistrationStoping" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventregistrationstoping/EventRegistrationStoping$Summary.jsp" />
