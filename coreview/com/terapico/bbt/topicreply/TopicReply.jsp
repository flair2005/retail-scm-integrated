...
<c:set var="ownerBeanName" value="topicReply" scope="request"/>
<c:set var="ownerClassName" value="TopicReply" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="topicReply" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/topicreply/TopicReply$Summary.jsp" />
