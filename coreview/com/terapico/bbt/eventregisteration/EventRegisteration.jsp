...
<c:set var="ownerBeanName" value="eventRegisteration" scope="request"/>
<c:set var="ownerClassName" value="EventRegisteration" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventRegisteration" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventregisteration/EventRegisteration$Summary.jsp" />
	...
	<div class="row">
<c:set var="event" value="${ result.event}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/event/Event$Info.jsp" />

<c:set var="communityUser" value="${ result.participant}" scope="request" />
...
<div class="row" desc="action list">
	...
	<a href='./eventRegisterationManager/transferToAnotherEvent/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='eventRegisteration' action=''>${userContext.localeMap['event_registeration.transfer_to_event']}</a>
<a href='./eventRegisterationManager/transferToAnotherParticipant/${ result.id}/' class='btn btn-primary btn-md submit col-xs-12 col-sm-6 col-md-3 col-md-2 ' beanName='eventRegisteration' action=''>${userContext.localeMap['event_registeration.transfer_to_participant']}</a>
