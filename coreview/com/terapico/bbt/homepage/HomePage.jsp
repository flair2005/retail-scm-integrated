...
<c:set var="ownerBeanName" value="homePage" scope="request"/>
<c:set var="ownerClassName" value="HomePage" scope="request"/>
...
<div class="row">
	...
	<c:if test='${(not empty userContext.accessTokens["taskFilterList"]) or ignoreListAccessControl}'>
			<li><a data-toggle="tab" href="#taskFilterList" class="disabled"> ${userContext.localeMap['task_filter']}</a></li>
	</c:if>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="homePage" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/homepage/HomePage$Summary.jsp" />
...
<jsp:include page="/coreview/com/terapico/bbt/community/Community$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["slideList"] or ignoreListAccessControl}'>
		<div id="slideList" class="tab-pane fade sublist" refer-name="home_page">
			<jsp:include page="/coreview/com/terapico/bbt/slide/Slide$List.jsp" >
				<jsp:param name="referName" value="homePage"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["encyclopediaItemList"] or ignoreListAccessControl}'>
		<div id="encyclopediaItemList" class="tab-pane fade sublist" refer-name="home_page">
	...
	<c:if test='${not empty userContext.accessTokens["taskFilterList"] or ignoreListAccessControl}'>
		<div id="taskFilterList" class="tab-pane fade sublist" refer-name="home_page">
			<jsp:include page="/coreview/com/terapico/bbt/taskfilter/TaskFilter$List.jsp" >
				<jsp:param name="referName" value="homePage"/>
			</jsp:include>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["taskList"] or ignoreListAccessControl}'>
		<div id="taskList" class="tab-pane fade sublist" refer-name="home_page">
	...
	<c:if test='${not empty userContext.accessTokens["threadList"] or ignoreListAccessControl}'>
		<div id="threadList" class="tab-pane fade sublist" refer-name="home_page">
