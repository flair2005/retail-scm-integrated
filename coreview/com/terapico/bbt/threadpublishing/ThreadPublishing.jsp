...
<c:set var="ownerBeanName" value="threadPublishing" scope="request"/>
<c:set var="ownerClassName" value="ThreadPublishing" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadPublishing" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadpublishing/ThreadPublishing$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["threadList"] or ignoreListAccessControl}'>
		<div id="threadList" class="tab-pane fade sublist" refer-name="publishing">
