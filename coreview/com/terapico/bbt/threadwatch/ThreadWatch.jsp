...
<c:set var="ownerBeanName" value="threadWatch" scope="request"/>
<c:set var="ownerClassName" value="ThreadWatch" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="threadWatch" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/threadwatch/ThreadWatch$Summary.jsp" />
