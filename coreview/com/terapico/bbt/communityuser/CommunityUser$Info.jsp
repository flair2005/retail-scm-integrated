...
<div class="col-xs-12 col-md-4 section">
	<b title="A CommunityUser">${userContext.localeMap['community_user']} </b><a href="#"><i class="fa fa-refresh" aria-hidden="true"></i></a>
	<hr/>
	<ul>
	
	
	<li><span>ID</span><a class="link-action-removed" href="./communityUserManager/loadCommunityUserDetail/${communityUser.id}/"> ${communityUser.id}</a></li>
