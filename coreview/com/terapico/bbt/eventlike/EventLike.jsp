...
<c:set var="ownerBeanName" value="eventLike" scope="request"/>
<c:set var="ownerClassName" value="EventLike" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventLike" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventlike/EventLike$Summary.jsp" />
