...
<c:set var="ownerBeanName" value="eventPublishing" scope="request"/>
<c:set var="ownerClassName" value="EventPublishing" scope="request"/>
...
<div class="row">
	...
	<c:if test='${(not empty userContext.accessTokens["eventList"]) or ignoreListAccessControl}'>
			<li><a data-toggle="tab" href="#eventList" class="disabled"> ${userContext.localeMap['event']}</a></li>
	</c:if>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventPublishing" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventpublishing/EventPublishing$Summary.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["eventList"] or ignoreListAccessControl}'>
		<div id="eventList" class="tab-pane fade sublist" refer-name="publishing">
			<jsp:include page="/coreview/com/terapico/bbt/event/Event$List.jsp" >
				<jsp:param name="referName" value="publishing"/>
			</jsp:include>
		</div>
	</c:if>
