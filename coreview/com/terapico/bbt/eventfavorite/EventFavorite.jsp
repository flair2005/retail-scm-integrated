...
<c:set var="ownerBeanName" value="eventFavorite" scope="request"/>
<c:set var="ownerClassName" value="EventFavorite" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="eventFavorite" value="${ result}" scope="request" />
<jsp:include page="/coreview/com/terapico/bbt/eventfavorite/EventFavorite$Summary.jsp" />
...
<c:set var="event" value="${ result.task}" scope="request" />
