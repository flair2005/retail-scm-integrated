...
public class BaseRelation{
	...
	protected void prepareRelationIndex()
	{
		...
		addRelationIndex("Report",reportRelatedObjectNames);

		String [] reportLineRelatedObjectNames = {"owner:Report"};
		addRelationIndex("ReportLine",reportLineRelatedObjectNames);
	...
	{
		addGenericRelation("Report"                                ,TRUST_CHAIN_READ,"owner");
		addGenericRelation("ReportLine"                            ,TRUST_CHAIN_READ,"owner");
