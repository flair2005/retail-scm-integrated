...
public class ReceivingSpace extends BaseEntity implements  java.io.Serializable{
	...
	public 	ReceivingSpace(String location, String contactNumber, String description, String totalArea, Warehouse warehouse, double latitude, double longitude
)
	{
	...
	public ReceivingSpace copyTo(ReceivingSpace dest){
	...
	public String toString(){
		...
		stringBuilder.append("receiving_space{");
