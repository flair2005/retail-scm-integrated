...
public class RetailStoreOrderShippingGroup extends BaseEntity implements  java.io.Serializable{
	...
	public 	RetailStoreOrderShippingGroup(String name, RetailStoreOrder bizOrder, double amount
)
	{
		setName(name);
	...
	public RetailStoreOrderShippingGroup copyTo(RetailStoreOrderShippingGroup dest){
	...
	public String toString(){
		...
		stringBuilder.append("retail_store_order_shipping_group{");
