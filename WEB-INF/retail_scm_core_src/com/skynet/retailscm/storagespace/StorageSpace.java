...
public class StorageSpace extends BaseEntity implements  java.io.Serializable{
	...
	public 	StorageSpace(String location, String contactNumber, String totalArea, Warehouse warehouse, double latitude, double longitude
)
	{
	...
	public StorageSpace copyTo(StorageSpace dest){
	...
	public String toString(){
		...
		stringBuilder.append("storage_space{");
