...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("Report"                                , BaseRelation.TRUST_CHAIN_ALL, "owner");
		//replaceGenericRelation("ReportLine"                            , BaseRelation.TRUST_CHAIN_ALL, "owner");
	...
	protected void prepareRelationIndex()
	{
		...
		*/
		//String [] reportRelatedObjectNames = {"owner:RetailStoreCountryCenter"};
		//replaceRelationIndex("Report",reportRelatedObjectNames);

		//String [] reportLineRelatedObjectNames = {"owner:Report"};
		//replaceRelationIndex("ReportLine",reportLineRelatedObjectNames);
		...
		//String [] levelOneDepartmentRelatedObjectNames = {"belongsTo:RetailStoreCountryCenter"};
		//replaceRelationIndex("LevelOneDepartment",levelOneDepartmentRelatedObjectNames);

		//String [] levelTwoDepartmentRelatedObjectNames = {"belongsTo:LevelOneDepartment"};
		//replaceRelationIndex("LevelTwoDepartment",levelTwoDepartmentRelatedObjectNames);

		//String [] levelThreeDepartmentRelatedObjectNames = {"belongsTo:LevelTwoDepartment"};
