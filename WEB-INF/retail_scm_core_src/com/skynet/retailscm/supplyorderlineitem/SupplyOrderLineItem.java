...
public class SupplyOrderLineItem extends BaseEntity implements  java.io.Serializable{
	...
	public 	SupplyOrderLineItem(SupplyOrder bizOrder, String skuId, String skuName, double amount, int quantity, String unitOfMeasurement
)
	{
	...
	public SupplyOrderLineItem copyTo(SupplyOrderLineItem dest){
	...
	public String toString(){
		...
		stringBuilder.append("supply_order_line_item{");
