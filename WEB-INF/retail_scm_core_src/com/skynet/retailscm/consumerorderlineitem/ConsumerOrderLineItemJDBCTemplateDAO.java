...
public class ConsumerOrderLineItemJDBCTemplateDAO extends CommonJDBCTemplateDAO implements ConsumerOrderLineItemDAO{
	...
	*/
	...
	protected void handleDeleteOneError(String consumerOrderLineItemId, int version) throws Exception {
		// the version has been changed, the client should reload it and ensure
		// this can be deleted
		String SQL = "select count(1) from " + this.getTableName() + " where id = ? ";
		Object[]  parameters = new Object[]{consumerOrderLineItemId};
	...
	protected String[] getNormalColumnNames() {
		...
		//return new String[]{"biz_order","sku_id","sku_name","price","quantity","amount"};
	...
	protected ConsumerOrderLineItem extractConsumerOrderLineItem(String consumerOrderLineItemId) throws Exception{
		String SQL = "select * from consumer_order_line_item_data where id = ?";	
		try{
		
			ConsumerOrderLineItem consumerOrderLineItem = queryForObject(SQL, new Object[]{consumerOrderLineItemId}, getConsumerOrderLineItemMapper());
			return consumerOrderLineItem;
		}catch(EmptyResultDataAccessException e){
			throw new ConsumerOrderLineItemNotFoundException("ConsumerOrderLineItem("+consumerOrderLineItemId+") is not found!");
		}
	...
	protected ConsumerOrderLineItem extractConsumerOrderLineItem(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
		String SQL = "select * from consumer_order_line_item_data where " + accessKey.getColumnName()+" = ?";	
		try{
		
			ConsumerOrderLineItem consumerOrderLineItem = queryForObject(SQL, new Object[]{accessKey.getValue()}, getConsumerOrderLineItemMapper());
			return consumerOrderLineItem;
		}catch(EmptyResultDataAccessException e){
	...
	protected ConsumerOrderLineItem loadInternalConsumerOrderLineItem(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
 	...
 	public SmartList<ConsumerOrderLineItem> findConsumerOrderLineItemByBizOrder(String consumerOrderId,Map<String,Object> options){
		...
		SmartList<ConsumerOrderLineItem> consumerOrderLineItemList = queryForList(SQL, new Object[]{consumerOrderId}, getConsumerOrderLineItemMapper());	
 	...
 	public SmartList<ConsumerOrderLineItem> findConsumerOrderLineItemByBizOrder(String consumerOrderId, int start, int count,Map<String,Object> options){
		...
		SmartList<ConsumerOrderLineItem> consumerOrderLineItemList = queryForList(SQL, new Object[]{consumerOrderId,start, count}, getConsumerOrderLineItemMapper());
	...
	protected boolean isUpdateRequest(ConsumerOrderLineItem consumerOrderLineItem){
 	...
 	protected Object[] prepareConsumerOrderLineItemUpdateParameters(ConsumerOrderLineItem consumerOrderLineItem){
 		...
 		parameters[6] = consumerOrderLineItem.getId();
 		parameters[7] = consumerOrderLineItem.getVersion();
