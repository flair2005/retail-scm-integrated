...
public class SupplyOrderTable{
	...
	static final String []ALL_CLOUMNS = {COLUMN_ID, 
		COLUMN_BUYER, COLUMN_SELLER, COLUMN_TITLE, COLUMN_TOTAL_AMOUNT, COLUMN_CONFIRMATION, COLUMN_APPROVAL, COLUMN_PROCESSING, COLUMN_PICKING, COLUMN_SHIPMENT, COLUMN_DELIVERY, COLUMN_CURRENT_STATUS, 
		COLUMN_VERSION};
